...
WALL_LIST_2ND_FLOOR = {
    ...
    [
        ...
        "                                        ",
        "WWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWW",
        "Waq==qaq==qaqqaSaq=qaq==qaSaqqaWWWWW===W",
        "Wq=WWWWWWW=q==qSq#S###S#=qSq==q=aqqaqqaW",
        "W==Waq====qa===S==SaqaSaqaS==S==qS=qS=qW",
        "W==W===========S==Sq=qSq=qS==S===S==S==W",
        "Wq=WWWWW=W=q==qSq=SqSqSq=qS==Sq=qS=qS=qW",
        "Waq=======qaqqaqaqqaqaqaqaq==qaqaqqaqqaW",
        "W==========qS##=q==########q=##=q#####qW",
        "W#########==Saqqaq=qaq====qaq========qaW",
        "Waq====qa==q#######=q=####Sq===========W",
        "Wq====aqqaqaqaSaq==qaq=qa=S==###=###=##W",
        "W==###q===S###=q########q=Sq====q======W",
        "Wq====q==qSaq==q========q=qaq==qaqaqaqaW",
        "Waq==qaqqaq===qaq======qa=Sq=####=q###qW",
        "Wq######qq#=##Sq=#######q==q======q===qW",
        "Wq======aq=qa=Saq=qaq==qaqqaq====qaq=qaW",
        "Waq=====qa##q######q####q==###########SW",
        "W#######q=aq=qaqqaqaqaqqaqqaqqaqqaq=qaSW",
        "Waq====qaqqqaSq=Sq=S=qS=qS=q==q==q===qSW",
        "Wq=###==qS==qS==Sq=S=qS==SS==S==S==S==SW",
        "Waq====qaS===S==Saq=qaS==SS==S==S==S==SW",
        "Wq#####=qSq==Sq=SqW==WS=qSSq=Sq=Sq=S=qSW",
        "Waq===qaqqaqaqaqqaW==W==aS=aqqaqqaq=qaSW",
        "WWWWWWWWWWWWWWWWWWW==WWWWWWWWWWWWWWWWWWW",
    ],
}
