...
WALL_LIST_2ND_FLOOR = {
    ...
    [
        ...
        "                                        ",
        "WWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWW",
        "Waq=======qaqqaS=========aS===WWWWWW===W",
        "Wq=WWWWWWW=q==qS=#S###S#=qS============W",
        "W==Waq====qa===S==SaqaSaqaS==S===S==S==W",
        "W==W===========S==Sq=qSq=qS==S===S==S==W",
        "Wq=WWWWW=W=q==qS==SqSqSq=qS==S===S==S==W",
        "Waq=======qaqqaq==qaqaqaqaq==========qaW",
        "W==========qS##====########==##==#####=W",
        "W#########==S==========================W",
        "Waq====qa==q#######===####S============W",
        "Wq====aqqaqaqaS===========S==###=###=##W",
        ...
        "Waq=====qa##q######=####===###########SW",
        "W#######q=============================SW",
        "Waq====qaq=qaS==S==S==S==S============SW",
        "Wq=###==qS==qS==S==S==S==SS==S==S==S==SW",
        "Waq====qaS===S==S=====S==SS==S==S==S==SW",
        "Wq#####=qS===S==S=W==WS==SS==S==S==S==SW",
        "Waq===qaq==qaq==qaW==W===S============SW",
        "WWWWWWWWWWWWWWWWWWW==WWWWWWWWWWWWWWWWWWW",
    ],
}
